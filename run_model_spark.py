...
lhssample        = read_csv(scenar_folder+"lhs-table-300-12uncertainties.csv")
...
def run_a_key(key):
    ...
    outputs = country_run(countrycode,scenar,datalist,paramvar,bc_all_surveys.value,switches)
    if outputs:
        forprim_bau,forprim_cc = country_run(countrycode,scenar,datalist,paramvar,bc_all_surveys.value,switches)
...
fn_out_bau = "outputs_spark_bau_{}_{}.csv".format(range_start,range_end)
fn_out_cc = "outputs_spark_cc_{}_{}.csv".format(range_start,range_end)
