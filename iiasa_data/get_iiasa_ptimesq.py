...
selectall = ((food.RCP=="No CC")|(food.RCP=="RCP8.5"))&(food.Year==2030)&(food.Policy=='NoMitig')&(food.GCM!="Avg")&(food.Item=="CRP")
selectq = (food.Var=="PROD")&(food.Unit=="1000 t")
selectp = (food.Var=="XPRP")

inter = food.ix[selectall&(selectq|selectp),:]
inter = inter.drop(["Year","Item","Policy","RCP","ID","Unit"],axis=1).set_index(['Reg','Macro','GCM','Var']).unstack('Var')['Val'].reset_index()
...
out.to_csv("boundaries_food.csv",index=False)
