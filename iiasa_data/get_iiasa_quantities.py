...
select = (food.Var=="PROD")&((food.RCP=="No CC")|(food.RCP=="RCP8.5"))&(food.Year==2030)&(food.Policy=='NoMitig')&(food.GCM!="Avg")&(food.Item=="CRP")&(food.Unit=="1000 t")
